...
<img src="../media/ReplaceVariables.png" width="500">
...
{: .warning }  
Using this setting will recreate the target SSIS environment variables. You would lose existing target environment variable values in this case.
